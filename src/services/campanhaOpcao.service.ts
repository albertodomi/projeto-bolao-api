...
export class CampanhaOpcaoService {
  static async create(campanhaId: number, data: z.infer<typeof CreateCampanhaOpcaoSchema>) {
  ...
  static async findByCampanha(campanhaId: number) {
  ...
  static async definirResultadoFinal(opcaoId: number) {
